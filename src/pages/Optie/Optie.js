    ...
    render(){
        return (
            <article className="optie">
                ...
                <p><span className="optie__tijd" role="img" aria-label="time"><FontAwesomeIcon icon={faClock}/> {this.props.status} {this.props.openingstijd} {this.props.sluitingstijd}</span></p>
            </article>
        );
    }
}
